  ...
  <div class="cont_circle">
    ...
    <div class="moon">
      <svg
        ...
        <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,-1028.3622)">
          <path
    ...
    <div class="cont_olas_bottom" @click="toggle()">
      <svg
        xmlns:dc="http://purl.org/dc/elements/1.1/"
        xmlns:cc="http://creativecommons.org/ns#"
        xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
        ...
        <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,-912.36216)">
          <g transform="translate(0.05230238,-83.806076)" id="g5323" style="fill: #ffffff; fill-opacity: 0.78604653">
            <path
              ...
              style="fill: #ffffff; fill-opacity: 0.78604653; stroke: none; stroke-opacity: 1" />
            <path
              sodipodi:nodetypes="ccsccccc"
              inkscape:connector-curvature="0"
              id="path4159-1"
          ...
          <g transform="matrix(1.0046942,0,0,1,-427.94717,-83.806076)" id="g5318" style="fill: #ffffff; fill-opacity: 0.78139535">
            <path
              style="fill: #ffffff; fill-opacity: 0.78139535; stroke: none; stroke-opacity: 1"
