...
<template>
  <svg id="blobSvg" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" style="opacity: 1">
    <image x="0" y="0" width="100%" height="100%" clip-path="url(#shape)" :href="imgUrl" preserveAspectRatio="none"></image>
    <defs>
